...
const LeadView: FunctionComponent<props> = ({
  index,
  lead,
  leadType,
  onPress,
    ...
    {leadFields ? (
        ...
        <>
          <TouchableOpacity
            ...
            {lead.data.project !== '' && (
              <Text style={styles.subHead}>{lead.data.project}</Text>
            )}
            {owner !== '' && (
              <Text style={styles.stage}>{properFormat(owner)}</Text>
            )}
            {role === 'Sales' && (
              <Text style={styles.stage}>
                {properFormat(user.user_first_name + ' ' + user.user_last_name)}
              </Text>
            )}
          </TouchableOpacity>
          {leadType === 'FOLLOWUP' || leadType === 'MISSED' ? (
            <View style={styles.iconViewFollwUp}>
              <IconArray size={7.2} lead={lead.data} leadId={lead.id} />
              <Text style={styles.stage}>
                {lead.data.next_follow_up_type === 'CALLBACK'
                  ? 'Call Back'
      ...
      {/* {lead.data.stage==='CALLBACK'&& leadFields===['']? (
        <>
          <TouchableOpacity
            style={
              selectLeads
      ...
      {lead.data.stage==='FRESH' && leadFields===[''] ? (
        <>
          <TouchableOpacity
            style={
              selectLeads
      ...
      {lead.data.stage==='INTERESTED' && leadFields===[''] ? (
        <>
          <TouchableOpacity
            style={
              selectLeads
      ...
      {lead.data.stage==='WON' && leadFields===[''] ? (
        <>
          <TouchableOpacity
            style={
              selectLeads
      ...
      {lead.data.stage==='NOT INTERESTED' && leadFields===[''] ? (
        <>
          <TouchableOpacity
            style={
              selectLeads
      ...
      {lead.data.stage==='LOST' && leadFields===[''] ? (
        <>
          <TouchableOpacity
            style={
              selectLeads
